...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $recs = Applicant::query()->orderBy('id', 'desc')->take(4)->get();

        // Start-of-Return-Functions

        return view('admin', compact('applicants', 'count', 'preschool', 'highschool', 'primary',
    ...
    {
        $recs = Applicant::query()->Find($id);

        $pdf = PDF::loadView('pdf', compact('recs'), ['recs' => $recs]);
