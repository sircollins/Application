...
<script src="dash/assets/plugins/morris/morris.min.js"></script>
<script src="dash/assets/plugins/raphael/raphael-min.js"></script>

<script src="dash/assets/pages/dashborad.js"></script>

<!-- Script of Responsive Tables -->
<!-- Responsive-table-->
<script src="dash/assets/plugins/RWD-Table-Patterns/dist/js/rwd-table.min.js" type="text/javascript"></script>
