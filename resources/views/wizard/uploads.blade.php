<div class="tab-pane" id="uploads">
    <div class="row">
        <h4 class="info-text"> Uploads or Attachments (Optional) </h4>
    </div>
   <div class="container-fluid">
       <div class="col-sm-6">
           <div class="input-group">
               ...
               <div class="file-browser">
                   <label class="control-label"><h4 class="strong">Parent Certified ID/Passport</h4></label>
                   <input type="file" name="scannedidpassport" class="file-browser">
               </div>
           </div>
           <br>
           <hr>
           <div class="input-group">
               ...
               <div class="file-browser">
                   <label class="control-label"><h4 class="strong">Proof of Residence</h4></label>
                   <input type="file" name="proof_of_residence" class="file-browser">
               </div>
           </div>
           <br>
           <br>
       ...
       <div class="col-sm-6">
           <div class="input-group">
               ...
               <div class="file-browser">
                   <label class="control-label"><h4 class="strong">Certified Child Birth Certificate</h4></label>
                   <input type="file" name="childbirth_cert" class="file-browser">
               </div>
           </div>
           <br>
           <hr>
           <div class="input-group">
               ...
               <div class="file-browser">
                   <label class="control-label"><h4 class="strong">Learners Recent Report</h4></label>
                   <input type="file" name="learners_report" class="file-browser">
               </div>
           </div>
           <br>
           <br>
    ...
    <div class="text-center">
        <div class="checkbox">
            <label>
                <input type="checkbox" name="terms&conditions" value="terms&conditions" checked  required>
                <strong>I Agree With Your</strong> <a target="_blank" href="#" data-toggle="modal">Terms & Conditions</a>
            </label>
        </div>
    </div>
    <hr style="width: 50%;">
        <!-- Modal Content
    <div class="modal fade in" id="Terms_Conditions" style="display: block;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil"></i>Terms And Conditions</h4>
                </div>
                <div class="modal-body" style="overflow:auto; height:460px;">
                    <h4>PARENT / GUARDIAN DECLARATION AND CONTRACT OF ENROLMENT</h4>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>4. PARENT'S GENERAL OBLIGATIONS</li>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btnTerms" style="padding:7px 20px;" class="btn btn-primary col-md-6 col-md-offset-3">
                        I Accept
                    </button>
                </div>
            </div>
